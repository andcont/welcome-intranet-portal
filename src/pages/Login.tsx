...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex-1 bg-gradient-andcont hidden lg:flex flex-col justify-center items-center text-white p-8">
      ...
      <div className="flex-1 flex justify-center items-center p-8 bg-gradient-to-br from-white to-gray-50">
